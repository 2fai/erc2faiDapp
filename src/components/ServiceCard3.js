...
import SecretPopover2 from './SecretPopover2';
...
function ServiceCard({
  ...
  return (
    <Card width={'100%'}>
      ...
      <CardBody style={{ color: 'white' }} paddingTop={2}>
        <div>
          <Text fontSize="md">{service}</Text>{' '}
          {/* Ajusta el fontSize y color según necesites */}
      ...
      >
        <SecretPopover2
          ...
          themeData={themeData}
          storeOnBaseFn={storeOnBaseFn}
          storeOnArbFn={storeOnArbFn}
          storeOnBNBFn={storeOnBNBFn}
        />
        {linkToEncodedData && (
          <Button
