...
function AddSecret({ saveSecret, themeData, enabled }) {
  ...
  const helpDocs = (
    <Text fontSize={'0.9rem'} marginTop={1} textAlign={'center'}>
      Need help?{' '}
      <a
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered>
        ...
        <ModalContent bg={'#111013'} mr="3" ml="3">
          <ModalHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <ModalBody>
                ...
                <Input
                  ...
                  defaultValue="DEXTOOLS" // Establece directamente el valor "DEXTOOLS"
                  readOnly // Hace el campo de texto solo de lectura
                  {...register('service', { required: true, maxLength: 80 })}
                  marginBottom={2}
                  sx={{
                    userSelect: 'none', // Evita que el texto pueda ser seleccionado
                    cursor: 'not-allowed', // Muestra el cursor como prohibido
                  }}
                />
                <Text>Account</Text>
                <Input
                  type="text"
                  placeholder="dextools@gmail.com"
